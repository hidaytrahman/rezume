        ...
        <section className="each-section personal-section-wrapper">
            ...
            <div className="personal-section">
                <div className="photo-container">
                    {
                        personal.avatar &&
                        <img src={personal.avatar} alt={personal.firstName} className="photo-avatar" />
                    }

                    <div className="p-details p-name">{personal.firstName} {personal.lastName}</div>
                ...
                <div className="p-details-container">
                    ...
                    <div className="p-details p-mobile"><label>Mobile: </label> {personal.mobile && personal.mobile.join('/')}</div>
                    <div className="p-details p-email"><label>Email: </label> <span>{personal.email}</span></div>
                    <div className="p-details p-address"><label>Address: </label> <span>{personal.address}</span></div>
                </div>
            </div>
            ...
            <div className="p-summary-container">
                ...
                <ul className="custom-list">
                    {
                         personal.summary && personal.summary.length > 0 &&
                        personal.summary.map((item, index) => (
                            <li key={index}>
                                {item}
                            </li>
                        ))
