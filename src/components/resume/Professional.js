                  ...
                  {item.projects &&
                    ...
                    item.projects.map((project, index) => (
                      <div key={index} className="e-company-list-project">
                        <h3 className="e-company-list-project-name">
                          {" "}
                          {project.name} <small>{project.url}</small>
                        </h3>
                        <p className="e-company-list-project-about">
                          {project.about}
                        </p>
                        <p className="e-company-list-project-responsibilities">
                          <strong>Responsibilities: </strong>
